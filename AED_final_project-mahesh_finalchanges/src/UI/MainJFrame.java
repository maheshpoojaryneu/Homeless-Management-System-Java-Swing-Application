...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        ...
        foodinventory=dB4OUtil.retrieveFInventory();
        system = dB4OUtil.retrieveSystem();
        //this.setSize(1680, 1050);
        this.homelessdirectory = new HomelessDirectory();
        this.enterprisedirectory= new EnterpriseDirectory();
        clothinventory=dB4OUtil.retrieveCInventory();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/Images/mark1.png"))); // NOI18N

        jLabel4.setBackground(new java.awt.Color(153, 204, 255));
        jLabel4.setFont(new java.awt.Font("STIX Two Math", 3, 58)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("HOMELESS MANAGEMENT SYSTEM");
