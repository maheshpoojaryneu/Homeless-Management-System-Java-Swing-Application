...
public class SelfWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public SelfWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, NetworkDirectory business, FoodInventory foodinventory, ClothInventory clothinventory, String username) {
        initComponents();
    ...
    private void btnManageEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseActionPerformed
        ClothingWorkAreaJPanel clothingworkareapanel =new ClothingWorkAreaJPanel(userProcessContainer, userAccount, organization, enterprise, business, clothinventory,username);
